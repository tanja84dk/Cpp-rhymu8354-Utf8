...
This is a library which implements [RFC 3629](https://tools.ietf.org/html/rfc3629),
"UTF-8 (Unicode Transformation Format)".

## Usage

The `Utf8::Utf8` class is used to encode or decode Unicode "code points", or characters from many different international character sets, in order to store or transmit them across any interface
